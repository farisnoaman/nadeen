...
export default async function RootLayout({children}:{children:React.ReactNode}){
  ...
  return <html lang={lang} dir={lang==='ar'?'rtl':'ltr'} data-scroll-behavior="smooth" className={theme==='dark'?'dark':undefined} style={{colorScheme:theme}} suppressHydrationWarning><body><Providers lang={lang} theme={theme}><WhatsAppProvider>{children}<WhatsAppFloat /></WhatsAppProvider></Providers></body></html>;
}
